...
echo "=========================================="
echo "Additional Pruning Configuration - HIGHEST"
echo "=========================================="
echo "Pre-pruned model: ${PRUNED_MODEL_PATH}"
echo "Additional sparsity: ${ADDITIONAL_SPARSITY} (0.5% of non-zero weights)"
echo "Pruning strategy: ${PRUNE_STRATEGY} (prune MOST important weights)"
